...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x0,0x42,0x79
	.DB  0x65,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 003A DDRD=0x00;
	OUT  0x11,R30
; 0000 003B 
; 0000 003C // Port E initialization
...
; 0000 003F PORTE=0x00;
	OUT  0x3,R30
; 0000 0040 DDRE=0x00;
	OUT  0x2,R30
; 0000 0041 
; 0000 0042 // Port F initialization
...
; 0000 0045 PORTF=0x00;
	STS  98,R30
; 0000 0046 DDRF=0x00;
	STS  97,R30
; 0000 0047 
; 0000 0048 // Port G initialization
; 0000 0049 // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 004A // State4=T State3=T State2=T State1=T State0=T
; 0000 004B PORTG=0x00;
	STS  101,R30
; 0000 004C DDRG=0x00;
	STS  100,R30
; 0000 004D 
; 0000 004E // Alphanumeric LCD initialization
; 0000 004F // Connections are specified in the
; 0000 0050 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0051 // RS - PORTC Bit 0
; 0000 0052 // RD - PORTC Bit 1
; 0000 0053 // EN - PORTC Bit 2
; 0000 0054 // D4 - PORTC Bit 4
; 0000 0055 // D5 - PORTC Bit 5
; 0000 0056 // D6 - PORTC Bit 6
; 0000 0057 // D7 - PORTC Bit 7
; 0000 0058 // Characters/line: 20
; 0000 0059 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 005A 
; 0000 005B while (1)
