...
_0x3:
	...
	BRNE _0x8
; 0000 005F    {
; 0000 0060         PORTB |= 0x01;
	SBI  0x5,0
; 0000 0061    }
; 0000 0062    else if(data == 'f')
	RJMP _0x9
_0x8:
	CPI  R16,102
	BRNE _0xA
; 0000 0063    {
; 0000 0064         PORTB &= 0xFE;
	CBI  0x5,0
; 0000 0065    }
; 0000 0066 }
_0xA:
...
; 0000 006D {
; 0000 006E char data;
; 0000 006F while (rx_counter0==0);
;	data -> R17
; 0000 0070 data=rx_buffer0[rx_rd_index0++];
...
_usart_tx_isr:
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0089 if (tx_counter0)
	TST  R7
	BREQ _0xF
; 0000 008A    {
; 0000 008B    --tx_counter0;
	DEC  R7
; 0000 008C    UDR0=tx_buffer0[tx_rd_index0++];
	MOV  R30,R8
	INC  R8
	LDI  R31,0
...
; 0000 008E    if (tx_rd_index0 == TX_BUFFER_SIZE0) tx_rd_index0=0;
	LDI  R30,LOW(8)
	CP   R30,R8
	BRNE _0x10
	CLR  R8
...
;void putchar(char c)
; 0000 0098 {
; 0000 0099 while (tx_counter0 == TX_BUFFER_SIZE0);
;	c -> Y+0
; 0000 009A #asm("cli")
; 0000 009B if (tx_counter0 || ((UCSR0A & DATA_REGISTER_EMPTY)==0))
; 0000 009C    {
...
; 0000 00BD // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=Out
; 0000 00BE // State7=T State6=T State5=T State4=T State3=T State2=T State1=T State0=0
...
; 0000 00D3 // USART Baud Rate: 9600
; 0000 00D4 UCSR0A=0x00;
	STS  192,R30
; 0000 00D5 UCSR0B=0xD8;
	LDI  R30,LOW(216)
	STS  193,R30
