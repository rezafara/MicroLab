...
_0x3:
; 0000 0045       {
; 0000 0046       while (((status=UCSR1A) & RX_COMPLETE)==0);
_0x6:
	LDS  R30,155
	MOV  R17,R30
	ANDI R30,LOW(0x80)
...
; 0000 0051 {
; 0000 0052 while ((UCSR1A & DATA_REGISTER_EMPTY)==0);
;	c -> Y+0
; 0000 0053 UDR1=c;
; 0000 0054 }
;#pragma used-
...
; 0000 0087 DDRG=0x00;
	STS  100,R30
; 0000 0088 
; 0000 0089 // USART1 initialization
; 0000 008A // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 008B // USART1 Receiver: On
; 0000 008C // USART1 Transmitter: On
; 0000 008D // USART1 Mode: Asynchronous
; 0000 008E // USART1 Baud Rate: 9600
; 0000 008F UCSR1A=0x00;
	STS  155,R30
; 0000 0090 UCSR1B=0x18;
	LDI  R30,LOW(24)
	STS  154,R30
; 0000 0091 UCSR1C=0x06;
	LDI  R30,LOW(6)
	STS  157,R30
; 0000 0092 UBRR1H=0x00;
	LDI  R30,LOW(0)
	STS  152,R30
; 0000 0093 UBRR1L=0x33;
	LDI  R30,LOW(51)
	STS  153,R30
; 0000 0094 
...
; 0000 009F // Characters/line: 20
; 0000 00A0 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 00A1 
; 0000 00A2 while (1)
...
; 0000 00A3       {
; 0000 00A4 
; 0000 00A5       for(i = 0; i < 80 ; i++){
	__GETWRN 16,17,0
_0x11:
	__CPWRN 16,17,80
	BRGE _0x12
; 0000 00A6         InputChar = getchar1();
	RCALL _getchar1
	MOV  R19,R30
; 0000 00A7         lcd_gotoxy(i % 20,(i / 20) % 4);
	MOVW R26,R16
	LDI  R30,LOW(20)
	LDI  R31,HIGH(20)
	CALL __MODW21
	...
	MOV  R26,R30
	RCALL _lcd_gotoxy
; 0000 00A8         lcd_putchar( InputChar );
	MOV  R26,R19
	RCALL _lcd_putchar
; 0000 00A9         }
	__ADDWRN 16,17,1
