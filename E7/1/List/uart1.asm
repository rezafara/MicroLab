...
; 0000 0055 {
_usartInit:
; 0000 0056     // USART1 initialization
; 0000 0057     // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 0058     // USART1 Receiver: On
; 0000 0059     // USART1 Transmitter: On
; 0000 005A     // USART1 Mode: Asynchronous
; 0000 005B     // USART1 Baud Rate: 9600
; 0000 005C     UCSR1A=0x00;
	LDI  R30,LOW(0)
	STS  155,R30
; 0000 005D     UCSR1B=0x18;
	LDI  R30,LOW(24)
	STS  154,R30
; 0000 005E     UCSR1C=0x06;
	LDI  R30,LOW(6)
	STS  157,R30
; 0000 005F     UBRR1H=0x00;
	LDI  R30,LOW(0)
	STS  152,R30
; 0000 0060     UBRR1L=0x33;
	LDI  R30,LOW(51)
	STS  153,R30
; 0000 0061 }
	RET
...
; 0000 008A     // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 008B     // State4=T State3=T State2=T State1=T State0=T
...
_0xD:
; 0000 0097 {
; 0000 0098     putchar1('M');
	LDI  R26,LOW(77)
	RCALL _putchar1
; 0000 0099     putchar1('a');
	LDI  R26,LOW(97)
	RCALL _putchar1
; 0000 009A     putchar1('h');
	LDI  R26,LOW(104)
	RCALL _putchar1
; 0000 009B     putchar1('d');
	LDI  R26,LOW(100)
	RCALL _putchar1
; 0000 009C     putchar1('i');
	LDI  R26,LOW(105)
	RCALL _putchar1
; 0000 009D     putchar1('\n');
	LDI  R26,LOW(10)
