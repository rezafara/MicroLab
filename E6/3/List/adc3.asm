...
; 0000 005C {
_read_adc:
; 0000 005D ADMUX=adc_input | (ADC_VREF_TYPE & 0xff);
	ST   -Y,R26
;	adc_input -> Y+0
	LD   R30,Y
	OUT  0x7,R30
...
; 0000 0063 while ((ADCSRA & 0x10)==0);
_0x11:
	SBIS 0x6,4
	RJMP _0x11
; 0000 0064 ADCSRA|=0x10;
	SBI  0x6,4
...
; 0000 007E // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 007F // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0092 PORTF=0x00;
	STS  98,R30
; 0000 0093 DDRF=0x00;
	STS  97,R30
; 0000 0094 
; 0000 0095 // Port G initialization
; 0000 0096 // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0097 // State4=T State3=T State2=T State1=T State0=T
; 0000 0098 PORTG=0x00;
	STS  101,R30
; 0000 0099 DDRG=0x00;
	STS  100,R30
; 0000 009A 
...
; 0000 009D // ADC Voltage Reference: AREF pin
; 0000 009E ADMUX=ADC_VREF_TYPE & 0xff;
	OUT  0x7,R30
; 0000 009F ADCSRA=0x83;
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 00A0 
; 0000 00A1 while (1)
...
; 0000 00A4       adcVal = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00A5       adcVal /= 100;
	MOVW R26,R16
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CALL __DIVW21
	MOVW R16,R30
; 0000 00A6       SetSevenSegement(adcVal);
	MOVW R26,R16
