...
; 0000 005E // ADC Clock frequency: 1000.000 kHz
; 0000 005F // ADC Voltage Reference: AREF pin
; 0000 0060 ADMUX=ADC_VREF_TYPE & 0xff;
	OUT  0x7,R30
; 0000 0061 ADCSRA=0x83;
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 0062 
; 0000 0063 while (1)
...
; 0000 0066       adcVal = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 0067 
; 0000 0068       if(adcVal >= 512)
	__CPWRN 16,17,512
	BRLT _0x9
; 0000 0069         PORTD = 0x01;
	LDI  R30,LOW(1)
	RJMP _0xC
; 0000 006A       else
_0x9:
