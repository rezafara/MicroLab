...
; 0000 0050 DDRD=0x00;
	OUT  0x11,R30
; 0000 0051 
; 0000 0052 // Port E initialization
...
; 0000 0055 PORTE=0x00;
	OUT  0x3,R30
; 0000 0056 DDRE=0x00;
	OUT  0x2,R30
; 0000 0057 
; 0000 0058 // Port F initialization
...
; 0000 005B PORTF=0x00;
	STS  98,R30
; 0000 005C DDRF=0x00;
	STS  97,R30
; 0000 005D 
; 0000 005E // Port G initialization
; 0000 005F // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0060 // State4=T State3=T State2=T State1=T State0=T
; 0000 0061 PORTG=0x00;
	STS  101,R30
; 0000 0062 DDRG=0x00;
	STS  100,R30
; 0000 0063 
...
; 0000 0066 // ADC Voltage Reference: AREF pin
...
; 0000 0075 lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 0076 //char* adcString = "%000";
; 0000 0077 while (1)
_0x6:
; 0000 0078       {
; 0000 0079 //      // Place your code here
; 0000 007A //          x=read_adc(0)   ;
; 0000 007B //          x =( x / 1023) * 100;
; 0000 007C //          //sprintf(adcString,"%d",x);
; 0000 007D //      lcd_gotoxy(0,0);
; 0000 007E //      lcd_puts((string) x);
; 0000 007F //
; 0000 0080 
; 0000 0081 
; 0000 0082       buf = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 0083       if(buf >= 1000) buf = 1000;
	__CPWRN 16,17,1000
	BRLT _0x9
	__GETWRN 16,17,1000
; 0000 0084       buf/=10;
...
; 0000 0086       buf%=100;
	...
	CALL __MODW21
	MOVW R16,R30
; 0000 0087       charBuff[1]=buf/10;
	MOVW R26,R16
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __DIVW21
	STD  Y+1,R30
; 0000 0088       charBuff[2]=buf%10;
	MOVW R26,R16
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __MODW21
	STD  Y+2,R30
; 0000 0089 
; 0000 008A //      buf = (buf/1023)*100;
; 0000 008B //
; 0000 008C //      charBuff[2]=buf % 10;
; 0000 008D //      charBuff[0]=buf/10 % 10;
; 0000 008E //      charBuff[1]=buf/100;
; 0000 008F 
; 0000 0090 
...
; 0000 0092       lcd_putchar('%');
	LDI  R26,LOW(37)
	RCALL _lcd_putchar
; 0000 0093       lcd_gotoxy(1,0);
	LDI  R30,LOW(1)
	CALL SUBOPT_0x0
; 0000 0094       lcd_putchar(charBuff[0]+'0');
	LD   R26,Y
	SUBI R26,-LOW(48)
	RCALL _lcd_putchar
; 0000 0095       lcd_gotoxy(2,0);
	LDI  R30,LOW(2)
	CALL SUBOPT_0x0
; 0000 0096       lcd_putchar(charBuff[1]+'0');
	LDD  R26,Y+1
	SUBI R26,-LOW(48)
	RCALL _lcd_putchar
; 0000 0097       lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 0098       lcd_putchar(charBuff[2]+'0');
	LDD  R26,Y+2
	SUBI R26,-LOW(48)
	RCALL _lcd_putchar
; 0000 0099       }
