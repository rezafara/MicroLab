...
; 0000 0050 // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0051 // State4=T State3=T State2=T State1=T State0=T
...
; 0000 0057 // Clock value: 8000.000 kHz
; 0000 0058 // Mode: Fast PWM top=0xFF
; 0000 0059 // OC0 output: Inverted PWM
; 0000 005A ASSR=0x00;
	OUT  0x30,R30
; 0000 005B TCCR0=0x7F;
	LDI  R30,LOW(127)
	OUT  0x33,R30
...
; 0000 0087 // OC3A output: Discon.
; 0000 0088 // OC3B output: Discon.
; 0000 0089 // OC3C output: Discon.
...
; 0000 0091 TCCR3A=0x00;
	STS  139,R30
; 0000 0092 TCCR3B=0x00;
	STS  138,R30
...
; 0000 00A5 // INT6: Off
; 0000 00A6 // INT7: Off
; 0000 00A7 EICRA=0x00;
	STS  106,R30
; 0000 00A8 EICRB=0x00;
	OUT  0x3A,R30
; 0000 00A9 EIMSK=0x00;
	OUT  0x39,R30
; 0000 00AA 
...
; 0000 00B1 // USART0 disabled
; 0000 00B2 UCSR0B=0x00;
	OUT  0xA,R30
; 0000 00B3 
; 0000 00B4 // USART1 initialization
; 0000 00B5 // USART1 disabled
; 0000 00B6 UCSR1B=0x00;
	STS  154,R30
; 0000 00B7 
